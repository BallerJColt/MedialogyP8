...
namespace EventCallbacks
{
    public class TerrainGenerator : MonoBehaviour
    {
        ...
        void OnGenerateTerrain(GenerateTerrainEvent generateTerrain)
        {
            ...
            newPillar = Instantiate(woodPillar, new Vector3(tileTransform.position.x - (generateTerrain.tileWidth / 2f) + (woodPillar.transform.localScale.x / 2), tileTransform.position.y + (0.5f * wallHeight), tileTransform.position.z - (generateTerrain.tileWidth / 2f) + (woodPillar.transform.localScale.z / 2)), Quaternion.identity);
